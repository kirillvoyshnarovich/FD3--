...
_reactDom2.default.render(_react2.default.createElement(ParentFrame, null), document.getElementById('container'));
...
var RainbowFrame = function (_React$Component) {
    ...
    _createClass(RainbowFrame, [{
        ...
        value: function render() {
            ...
            var frames = this.props.colors.map(function (element) {
                console.log(element);
            });
